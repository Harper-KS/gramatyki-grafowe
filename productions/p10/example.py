...
output_dir = "./productions/p10/outputs"
...
h.R = 1
# Before
graph1.visualize(os.path.join(output_dir, "example_p10_before.png"))

can_apply, matched = production.can_apply(graph1)
if can_apply:
    production.apply(graph1, matched)

graph1.visualize(os.path.join(output_dir, "example_p10_after.png"))
...
# Before applying
graph2.visualize(os.path.join(output_dir, "example_p10_larger_graph_before.png"))
...
# After applying
graph2.visualize(os.path.join(output_dir, "example_p10_larger_graph_after.png"))
